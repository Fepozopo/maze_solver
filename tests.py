...
class Tests(unittest.TestCase):
    ...
    def test_maze_break_walls(self):
        ...
        self.assertEqual(
            m1.cells[0][0].has_bottom_wall,
            False,
        )

        self.assertEqual(
            m1.cells[5][5].has_left_wall,
            True,
        )
        self.assertEqual(
            m1.cells[5][5].has_right_wall,
            False,
        )
        self.assertEqual(
            m1.cells[5][5].has_top_wall,
            False,
        )
        self.assertEqual(
            m1.cells[5][5].has_bottom_wall,
            True,
        )
